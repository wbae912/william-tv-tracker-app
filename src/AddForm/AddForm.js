...
export default class AddForm extends Component {
  ...
  render() {
    ...
    return (
      <section className="add-form-section" role="main">
        ...
        <form className="add-show-form" id="add-show-form" onSubmit={e => {
          ...
          <div className="form-section">
            ...
            <input type="text" name="tv_title" id="tv_title" className="add-form-input" required aria-required="true" aria-invalid="true"
          ...
          <div className="form-section">
            ...
            <select name="status" id="status" className="add-form-select" required aria-required="true" aria-invalid="true"
